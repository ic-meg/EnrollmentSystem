            ...
            <div class="form-section">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="last-name" name="last-name" value="<?= isset($profile['first_name']) ? htmlspecialchars($profile['last_name']) : '' ?>" readonly require>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" id="guardian-name" name="guardian-name" value="<?= isset($profile['guardian_name']) ? htmlspecialchars($profile['guardian_name']) : '' ?>" readonly required>
                </div>
                <div class="form-group">
                  <label for="guardian-contact">*Guardian's Contact</label>
                  <input type="tel" id="guardian-contact" name="guardian-contact" value="<?= isset($profile['guardian_contact']) ? htmlspecialchars($profile['guardian_contact']) : '' ?>" maxlength="11" readonly required />
