...
<main>
    ...
    <div class="schedule-news-calendar">
        <div class="cards" style="margin-top: -30px;">
            <div class="card">
                <img src="Approval.png" alt="logo" class="stud-db-logo" style="display: block; margin: 0 auto;">
                <p class="label" style="white-space: nowrap;">STATUS:</p>
                <p class="value" style="white-space: nowrap;">Enrolled</p>
            </div>
            <div class="card">
                <img src="Stack of coins.png" alt="logo" class="stud-db-logo" style="display: block; margin: 0 auto;">
                <p class="label" style="white-space: nowrap;">Total Fee:</p>
                <p class="value" style="white-space: nowrap;">123,456.78</p>
            </div>
            <div class="card" style="height: auto;">
                <img src="Books.png" alt="logo" class="stud-db-logo" style="display: block; margin: 0 auto;">
        ...
        <!-- Schedule and News Section -->
            <div class="cards1">
                <div class="card1">
                    <img src="Approval.png" alt="logo" style="display: block; margin: 0 auto;">
