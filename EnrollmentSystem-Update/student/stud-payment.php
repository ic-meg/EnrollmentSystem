...
<head>
  ...
  <title>Oxford Academe | Payment</title>
    ...
    <div class="container">
      ...
      <div class="main--container">
        ...
        <div class="payment-method">
            ...
            <div class="methods">
            <img src="studPic/paypal.jpg" alt="PayPal">
            <img src="studPic/gcash.png" alt="GCash">
            <span>Cash</span>
            </div>
        </div>
        ...
        <div class="card-payment">
            ...
            <img src="studPic/visa-logo.png" alt="Visa">
            <img src="studPic/master-card.jpg" alt="MasterCard">
            <img src="studPic/apple-pay.png" alt="Apple Pay">
            </div>
            <form>
            <div class="form-row">
        ...
        <p class="transaction-type"><img src="studPic/master-card.jpg" alt="MasterCard"> Debit Card</p>
        <hr>
