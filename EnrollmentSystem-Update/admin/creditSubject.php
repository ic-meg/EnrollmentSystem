        ...
        <div class="container">
            <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="John Doe" disabled class="mt-1 block w-full border-gray-300 rounded-lg bg-gray-100 p-2">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Course</label>
                    <input type="text" value="Computer Science" disabled class="mt-1 block w-full border-gray-300 rounded-lg bg-gray-100 p-2">
                </div>
